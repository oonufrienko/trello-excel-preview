...
- Embedded image positioning may drift slightly from the original Excel layout. This is more noticeable on non-first sheets of multi-sheet workbooks but can also occur on the first sheet, depending on the file's column widths and row heights.
